...
export const ui = {
  en: {
    ...
    'getStarted.firefox.desc': 'Firefox support is coming soon. Stay tuned!',
    'getStarted.firefox.cta': 'Coming Soon',
  ...
  zh: {
    ...
    'getStarted.firefox.title': 'Mozilla Firefox',
    'getStarted.firefox.desc': 'Firefox 支持即将推出，敬请期待！',
    'getStarted.firefox.cta': '即将上线',
    'getStarted.edge.title': 'Microsoft Edge',
